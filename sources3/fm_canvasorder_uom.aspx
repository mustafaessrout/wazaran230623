<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_canvasorder_uom.aspx.cs" Inherits="fm_canvasorder_uom" %>
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <div class="row">
                    ...
                    <label class="control-label col-md-1">Tax Disc <asp:Label runat="server" ID="lbtotDiscTax"></asp:Label> %</label>
                    <div class="col-md-2">
