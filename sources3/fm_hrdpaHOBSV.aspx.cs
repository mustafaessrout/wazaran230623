            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lbtarget != null && lblids != null)
                {
                    ...
                    else if (lblobjective.Text == "Customer Coverage")
                    {
                        ...
                        var tempData = bll.vLookUp("select sum(achievement) from trpt_hrd_kpiresultdtl where period ='" + Convert.ToString(cbperiod.SelectedValue) + "' and objective like '%Customer Coverage%' and salespointcd='"+cbsalespoint.SelectedValue.ToString() + "' and emp_Cd in (select emp_cd from tmst_activedriver where salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and isBSV=0 )");
                        if (lbachievement == null && lblkeyresp_nm.Text == "DELIVERY PRODUCT")
                        {
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "sweetAlert('You can not edit delivery product!','DELIVERY PRODUCT','warning');", true);
                        }
                    ...
                    {
                        //var tempData = bll.vLookUp("select dbo.fn_totalCustomerAchive_invoice('" + Convert.ToString(cbemployee.SelectedValue) + "','" + Convert.ToString(cbperiod.SelectedValue) + "')");
                        var tempData = bll.vLookUp("select sum(achievement) from trpt_hrd_kpiresultdtl where period ='" + Convert.ToString(cbperiod.SelectedValue) + "' and objective like '%APPEARANCE AND MANNER%' and salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and emp_Cd in (select emp_cd from tmst_activedriver where salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and isBSV=0 )");
                        if (lbachievement == null && lblkeyresp_nm.Text == "DELIVERY PRODUCT")
                        {
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "sweetAlert('You can not edit delivery product!','DELIVERY PRODUCT','warning');", true);
                        }
                    ...
                    {
                        //var tempData = bll.vLookUp("select dbo.fn_totalCustomerAchive_invoice('" + Convert.ToString(cbemployee.SelectedValue) + "','" + Convert.ToString(cbperiod.SelectedValue) + "')");
                        var tempData = bll.vLookUp("select sum(achievement) from trpt_hrd_kpiresultdtl where period ='" + Convert.ToString(cbperiod.SelectedValue) + "' and objective like '%PUNCTUALITY%' and salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and emp_Cd in (select emp_cd from tmst_activedriver where salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and isBSV=0 )");
                        if (lbachievement == null && lblkeyresp_nm.Text == "DELIVERY PRODUCT")
                        {
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "sweetAlert('You can not edit delivery product!','DELIVERY PRODUCT','warning');", true);
                        }
                    ...
                    {
                        //var tempData = bll.vLookUp("select dbo.fn_totalCustomerAchive_invoice('" + Convert.ToString(cbemployee.SelectedValue) + "','" + Convert.ToString(cbperiod.SelectedValue) + "')");
                        var tempData = bll.vLookUp("select sum(achievement) from trpt_hrd_kpiresultdtl where period ='" + Convert.ToString(cbperiod.SelectedValue) + "' and objective like '%ATTITUDE%' and salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and emp_Cd in (select emp_cd from tmst_activedriver where salespointcd='" + cbsalespoint.SelectedValue.ToString() + "' and isBSV=0 )");
                        if (lbachievement == null && lblkeyresp_nm.Text == "DELIVERY PRODUCT")
                        {
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "sweetAlert('You can not edit delivery product!','DELIVERY PRODUCT','warning');", true);
                        }
