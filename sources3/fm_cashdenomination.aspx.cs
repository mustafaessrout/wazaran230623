...
public partial class fm_cashdenomination : System.Web.UI.Page
{
    ...
    {
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "op", "openreport('fm_report2.aspx?src=cshden&sap=" + cbsalespoint.SelectedValue.ToString() + "');", true);
    }
}