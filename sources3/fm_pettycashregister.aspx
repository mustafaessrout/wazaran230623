<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_pettycashregister.aspx.cs" Inherits="fm_pettycashregister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="alert alert-info text-bold">PETTY CASH REGISTER</div>
    <div class="container">
         
        <div class="form-horizontal">
            <%--   <h4 class="jajarangenjang">PETTY CASH REGISTER</h4>
            ...
            <div class="container">
                <div class="form-group">
                    <div class="row margin-bottom">
                        ...
                        <div class="col-md-2 drop-down">
                            <asp:DropDownList ID="cbinout" onChange="ShowProgress();" CssClass="form-control input-sm" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbinout_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                   ...
                   <%-- <div class="row margin-bottom">
                    ...
                    <div class="row margin-bottom margin-top alert alert-info">
