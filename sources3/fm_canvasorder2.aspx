<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_canvasorder2.aspx.cs" Inherits="fm_canvasorder2" %>
    ...
    <div style="text-align: center;" class="navi margin-bottom">
        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
            <ContentTemplate>
                ...
                <asp:LinkButton ID="btnew" runat="server" OnClick="btnew_Click" CssClass="btn btn-success bt-add "><span >New Canvas</span></asp:LinkButton>
                <asp:LinkButton ID="btsave" runat="server" CssClass="btn btn-warning" OnClientClick="javascript:ShowProgress();" OnClick="btsave_Click"><span >Save</span></asp:LinkButton>
                ...
                <asp:LinkButton ID="btprintinvoice" runat="server" OnClick="btprintinvoice_Click" CssClass="btn btn-info ">Print Invoice</asp:LinkButton>
                ...
                <asp:LinkButton ID="btprintall" runat="server" OnClick="btprintall_Click" CssClass="btn btn-info">Print All</asp:LinkButton>
