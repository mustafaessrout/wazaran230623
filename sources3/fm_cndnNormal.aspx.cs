...
public partial class fm_cndnNormal : System.Web.UI.Page
{
    ...
    {
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "opr", "openreport('fm_report2.aspx?src=CNDNNormal&cndnFrom=" + dtPostFromDate.Text + "&cndnTo=" + dtPostToDate.Text + "');", true);
    }
}