<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_paymentreceipt_ho.aspx.cs" Inherits="fm_paymentreceipt_ho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="form-horizontal">
            <div class="form-group" style="background-color: yellow">
                ...
                <div class="col-md-2 drop-down">
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbsource" onchange="javascript:ShowProgress();" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="cbsource_SelectedIndexChanged">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>

                </div>
                <label class="control-label col-md-1">Pay Date</label>
                ...
                <label class="control-label col-md-1">P Type</label>
                <div class="col-md-2 drop-down">
                    <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbpaymnttype" runat="server" CssClass="form-control" AutoPostBack="True" PlaceHolder="Leave it empty, it mandatory on Cleareance" OnSelectedIndexChanged="cbpaymnttype_SelectedIndexChanged"></asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>

                <label class="control-label col-md-1">Doc No</label>
                <div class="col-md-2">
            ...
            <div class="form-group">
                <%--<label class="control-label col-md-1">Tab No</label>
                <div class="col-md-2">
                ...
                <label class="control-label col-md-1">Rcp No</label>
                <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label col-md-1">Due Dt</label>
                <div class="col-md-2">
                ...
                <label class="control-label col-md-1">BankCQ: </label>
                <div class="col-md-2 drop-down">
                ...
                <label class="control-label col-md-1">BankHO</label>
                <div class="col-md-2 drop-down">
                ...
                <label class="control-label col-md-1">HO REC Date</label>
                <div class="col-md-2">
            ...
            <div class="form-group">
                <label class="control-label col-md-1">HO VCR No</label>
                <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                <div class="col-md-1">
                    <asp:LinkButton ID="btaddsalespoint" runat="server" CssClass="btn btn-success" OnClick="btaddsalespoint_Click">Add</asp:LinkButton>
                </div>
                <div class="col-md-8">
            ...
            <div class="h-divider"></div>
            <div class="form-group">
                <label class="control-label col-md-1">Paid For</label>
                <div class="col-md-2 drop-down">
                ...
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel88" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txcust" runat="server" CssClass="form-control ro"></asp:TextBox>
            ...
            <div class="h-divider"></div>
            <div class="form-group">
                <label class="control-label col-md-1">Tot Amount Paid</label>
                ...
                <label class="control-label col-md-1">Promise Payment</label>
                <div class="col-md-2">
                ...
                <label class="control-label col-md-1">Man/Auto</label>
                <div class="col-md-2 drop-down">
                ...
                <label class="control-label col-md-1">Payment Status (BT/CQ)</label>
                <div class="col-md-2 drop-down">
            ...
            <div class="form-group">
                <div class="col-md-3">
                    <asp:UpdatePanel ID="UpdatePanel32" runat="server">
                        <ContentTemplate>
                            <i>
                            <asp:CheckBox ID="chAdvance" CssClass="form-control" runat="server" Enabled="false" AutoPostBack="true" OnCheckedChanged="chAdvance_CheckedChanged" Text="* Tick This if Payment as Advance!!!" />
                            </i>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <table class="mGrid" runat="server" id="tblInvoice">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lbSalespoint" CssClass="control-label" runat="server" Text=""></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="btadd" CssClass="btn btn-primary" runat="server" OnClick="btadd_Click">Add Paid</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                    </ContentTemplate>
                            ...
                            <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" CssClass="table table-striepd mygrid" EmptyDataText="No Invoice Found" ShowHeaderWhenEmpty="True" OnRowDataBound="grd_RowDataBound" ShowFooter="True" OnRowCancelingEdit="grd_RowCancelingEdit" OnRowEditing="grd_RowEditing" OnRowUpdating="grd_RowUpdating" OnRowDeleting="grd_RowDeleting">
                                <Columns>
                                    <asp:TemplateField HeaderText="Branch">
                                        <ItemTemplate>
                                            <asp:Label ID="lbsalespoint" runat="server" Text='<%# Eval("salespoint_nm") %>'></asp:Label>
                                            <asp:HiddenField ID="hdsalespoint" runat="server" Value='<%# Eval("salespointcd") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <div class="form-group">
                <label class="control-label col-md-offset-8 col-md-1">Suspense</label>
                <div class="col-md-2">
    ...
    <div class="container margin-bottom">
        <div class="form-group">
            ...
            <label class="control-label col-md-1">Total Paid</label>
            <div class="col-md-2">
    ...
    <div class="margin-bottom navi ">
        <asp:UpdatePanel ID="UpdatePanel16" runat="server">
            <ContentTemplate>
                ...
                <asp:LinkButton ID="btprintall" runat="server" CssClass="btn btn-info" OnClick="btprintall_Click">Print All</asp:LinkButton>
