<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_internaltransfer2.aspx.cs" Inherits="fm_internaltransfer2" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server" class="text-left">
                            <ContentTemplate>
                                ...
                                <asp:TextBox ID="txitem" runat="server" OnTextChanged="txitem_TextChanged" CssClass="form-control col-sm-6 input-sm" Style="border-radius: 4px; display: inline-block; width: calc(60% - 5px); margin-right: 5px;" AutoPostBack="true"></asp:TextBox>
                    ...
                    <td style="min-width: 25px; width: 100px;">
                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txstk" runat="server" CssClass="makeitreadonly ro form-control input-sm" ></asp:TextBox>
                            </ContentTemplate>
                            <Triggers>
                    ...
                    <td style="min-width: 25px; width: 100px;">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:Button ID="btsearch" runat="server" Text="Add" CssClass="btn-success btn btn-sm btn-add" AutoPostBack="True" OnClick="btsearch_Click" />
                                <asp:Button ID="Button1" runat="server" Text="Add 1" CssClass="btn-success btn btn-sm btn-add" AutoPostBack="True" OnClientClick="window.scrollTo(0, document.body.scrollHeight)" Style="display: none" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
