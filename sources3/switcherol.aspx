<%@ Page Language="C#" AutoEventWireup="true" CodeFile="switcherol.aspx.cs" Inherits="switcherol" %>
    ...
    <div>
        <div class="container-fluid">
            <%--<div class="header animated fadeInUp">--%>
                <div class="center ">
                    <div class="logo ">
                        <img src="image/logo_tw.png" alt="logo sbtc"/>
                    </div>
                </div>
            ...
            <div class="container margin-bottom">
                <div class="clearfix top-text text-white">
                    ...
                    <asp:Label ID="lbcaption" CssClass="pull-right no-margin" runat="server" Text="* Please select Wazaran Application from Portal"></asp:Label>
                </div>
			    <div class="tile-container">
                    <%
                        ...
                        {     
                    %>
				    <a href="<%=rs["urls"].ToString() %>?sp=<%=rs["salespointcd"].ToString() %>" class="tile fg-white animated flipInX" data-role="tile">
				        <div class="btns ">
                            <div class="btn-1">
                                <svg>
                                ...
                                <div class="cntn">
                                    ...
                                    <p><b><%=rs["salespointcd"].ToString() %></b><br /><br /><b><%=rs["app_nm"].ToString() %></b></p>
                                </div>
                            </div>
                        </div>	
				    </a>
