...
public partial class fm_cmo_std_ho2 : System.Web.UI.Page
{
    cbll bll = new cbll();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            showItemList.Attributes.Add("style","display:none");
            showItemStock.Attributes.Add("style", "display:none");
    ...
    protected void cbMonthCD_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        arr.Clear();
        arr.Add(new cArrayList("@type", "item"));
        arr.Add(new cArrayList("@period", cbMonthCD.SelectedValue.ToString()));
        bll.vGetSTDItemList(arr, ref rs);
        while (rs.Read())
        {
        ...
        bll.vBindingGridToSp(ref grditemstock, "sp_tpch_salesplan_item_get", arr);
    }
    ...
    protected void grditemstock_RowCreated(object sender, GridViewRowEventArgs e)
    {
