<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookup_proposal3.aspx.cs" Inherits="lookup_proposal3" %>
        ...
        <div class="containers bg-white">
            ...
            <div class="divgrid margin-top margin-bottom">
                <div class="overflow-y" style="height:450px;">
                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CellPadding="0" GridLines="None" CssClass="table table-striped mygrid table-fix" AllowPaging="True" PageSize="30">
                        <AlternatingRowStyle />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="cndn date">
                                <ItemTemplate><%# Eval("cndn_dt","{0:dd/MM/yyyy}") %></ItemTemplate>
                            </asp:TemplateField>
