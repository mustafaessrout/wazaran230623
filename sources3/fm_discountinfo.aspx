            ...
            <form id="form1" runat="server" class="container-fluid">
                ...
                <div class="clearfix margin-bottom">
                    ...
                    <div class=" clearfix col-sm-6 no-padding">
                        ...
                        <div class="clearfix">
                            <asp:Label Text="Maximum Discount" runat="server" CssClass="titik-dua col-xs-4 control-label control-label-sm" />
                            <div class="col-xs-8 ">
                                <asp:Label ID="lbmaxdisc" runat="server" CssClass="padding-top-4 block"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
