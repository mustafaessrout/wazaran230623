<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="fm_lookup_return.aspx.cs" Inherits="fm_lookup_return" %>
...
<body style="font-family:Tahoma,Verdana;font-size:small">
    ...
    <div>
        ...
        <div>Search :&nbsp;
            <asp:DropDownList ID="cbstatus" runat="server" Width="20em">
            </asp:DropDownList>
                ...
                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" Width="362px" OnSelectedIndexChanged="grd_SelectedIndexChanged">
                    <Columns>
                        <asp:TemplateField HeaderText="Return No.">
                            <ItemTemplate>
                                <asp:Label ID="lbreturnCD" runat="server" Text='<%# Eval("returnCD") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField  Visible=false>
                            <ItemTemplate>
                                <asp:label ID="lbreturnID" runat="server" Text='<%# Eval("returnID")%>'></asp:label>
                            </ItemTemplate>
                        </asp:TemplateField>
