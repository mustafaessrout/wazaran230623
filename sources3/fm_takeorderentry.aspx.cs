...
public partial class fm_takeorderentry : System.Web.UI.Page
{
    cbll bll = new cbll();
    double dQtyOrder = 0;
    double dSubTotal = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            catch (Exception ex)
            {
                ...
                bll.vHandledError(ref ex, Request.Cookies["sp"].Value.ToString()+" : fm_takeorderentry");
    ...
    protected void btnew_Click(object sender, EventArgs e)
    {
        ...
        // hdto.Value = "";
        Response.Redirect("fm_takeorderentry.aspx");
    }
