<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_salesreceipt2_uom.aspx.cs" Inherits="fm_salesreceipt2_uom" %>
                        ...
                        <asp:GridView ID="grd" CssClass="mGrid" runat="server" AutoGenerateColumns="False" OnRowEditing="grd_RowEditing" OnRowUpdating="grd_RowUpdating" OnRowCancelingEdit="grd_RowCancelingEdit" ShowFooter="True" CellPadding="0">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Qty Received">
                                    <ItemTemplate>
                                        <asp:Label ID="lbqtyshipment_conv" runat="server" Text='<%# Eval("qty_conv") %>'></asp:Label>
                                        <asp:HiddenField ID="lbqtyshipment" runat="server" Value='<%# Eval("qty") %>' />
                                        <asp:HiddenField ID="hdqtyshipment_ctn" runat="server" Value='<%# Eval("qty_ctn") %>' />
                                        <asp:HiddenField ID="hdqtyshipment_pcs" runat="server" Value='<%# Eval("qty_pcs") %>' />
                                        <asp:HiddenField ID="hdqtyconv_ctn" runat="server" Value='<%# Eval("qty_conv_ctn") %>' />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <asp:HiddenField ID="hdtotqtyshipment" runat="server" />
                                    </FooterTemplate>
                                </asp:TemplateField>
                ...
                <asp:GridView ID="grdfree" CssClass="mGrid" runat="server" AutoGenerateColumns="False" CellPadding="0" EmptyDataText="Free Item Not Found" ShowHeaderWhenEmpty="True" ShowFooter="True" OnRowCancelingEdit="grdfree_RowCancelingEdit" OnRowEditing="grdfree_RowEditing" OnRowUpdating="grdfree_RowUpdating" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Qty Free">
                            <ItemTemplate>
                                <asp:Label ID="lbqtyfree_conv" runat="server" Text='<%# Eval("qtyfree_conv") %>'></asp:Label>
                                <asp:HiddenField ID="lbqtyfree" runat="server" Value='<%# Eval("qtyfree") %>' />
                                <asp:HiddenField ID="hdqtyfree_ctn" runat="server" Value='<%# Eval("qtyfree_ctn") %>' />
                                <asp:HiddenField ID="hdqtyfree_pcs" runat="server" Value='<%# Eval("qtyfree_pcs") %>' />
                                <asp:HiddenField ID="hduom" runat="server" Value='<%# Eval("uom") %>' />
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Qty Received">
                            <ItemTemplate>
                                <asp:Label ID="lbqtyreceived_conv" runat="server" Text='<%# Eval("qtyfree_conv") %>'></asp:Label>
                                <asp:HiddenField ID="lbqtyreceived" runat="server" Value='<%# Eval("qtyfree") %>' />
                                <asp:HiddenField ID="hdqtyreceived_ctn" runat="server" Value='<%# Eval("qtyfree_ctn") %>' />
                                <asp:HiddenField ID="hdqtyreceived_pcs" runat="server" Value='<%# Eval("qtyfree_pcs") %>' />
                                <asp:HiddenField ID="hdqtyconv_ctn" runat="server" Value='<%# Eval("qty_conv_ctn") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                            ...
                            <FooterTemplate>
                                ...
                                <asp:HiddenField ID="hdtotreceived" runat="server" />
                            </FooterTemplate>
                        </asp:TemplateField>
                        <asp:CommandField HeaderText="Change Qty" ShowEditButton="False" />
                    </Columns>
            ...
            <div class="col-md-2">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Label ID="lbdeliveryuom" CssClass="control-label" Style="font-size: xx-large; font-weight: bold" runat="server" BackColor="Silver"></asp:Label>
                    </ContentTemplate>
                </asp:UpdatePanel>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Qty Bring by driver">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdqtydriver" runat="server" Value='<%# Eval("qty") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                            ...
                            <FooterTemplate>
                                ...
                                <asp:HiddenField ID="hdtotqty" runat="server" />
                            </FooterTemplate>
                        </asp:TemplateField>
