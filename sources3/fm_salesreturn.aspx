<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_salesreturn.aspx.cs" Inherits="fm_salesreturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--  <div class="jajarangenjang">Sales Return</div>
    <div class="h-divider"></div>--%>
    <div class="alert alert-info text-bold">Sales Return</div>
    <div class="container">
        <div class="form-group">
            <div class="row margin-bottom">
                ...
                <div class="col-md-3">
                    <asp:RadioButtonList ID="rdreturtype" onchange="javascript:ShowProgress();" runat="server" AutoPostBack="True" CellPadding="0" CellSpacing="0" OnSelectedIndexChanged="rdreturtype_SelectedIndexChanged" RepeatDirection="Horizontal" CssClass="well well-sm radio radio-inline no-margin" BackColor="Yellow">
                        <asp:ListItem Value="C">Return Van In</asp:ListItem>
            ...
            <div class="row margin-bottom">
                ...
                <label class="col-md-1 control-label">Tab No.</label>
                <div class="col-md-2">
                    <div class="input-group">
                        <asp:TextBox ID="txtabno" runat="server" CssClass="form-control"></asp:TextBox>
                        <div class="input-group-btn">
                            <asp:LinkButton OnClientClick="ShowProgress();PopupCenter('fm_tabsalesreturn.aspx','Tab Salesreturn',1000,800);" ID="bttabsearch" CssClass="btn btn-primary" runat="server"><i class="fa fa-search"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            ...
            <div class="row margin-bottom">
                <label class="col-md-1 control-label">Payment No.</label>
                <div class="col-md-2">
                    <asp:TextBox ID="txpaymentno" runat="server" Width="100%" CssClass="form-control ro">NEW</asp:TextBox>
                </div>
                ...
                <div class="col-md-5 drop-down require">
            ...
            <div class="row margin-bottom">
                ...
                <div class="col-md-3">
                    <asp:UpdatePanel ID="UpdatePanel9" runat="server" class="input-group">
                        <ContentTemplate>
                            <asp:TextBox ID="txsearchcust" runat="server" CssClass="form-control"></asp:TextBox>
                            <div class="input-group-btn">
                                <asp:LinkButton ID="btsearchcust" OnClientClick="ShowProgress();" OnClick="btsearchcust_Click" CssClass="btn btn-primary" runat="server"><i class="fa fa-search"></i></asp:LinkButton>
                            </div>
                            <asp:AutoCompleteExtender CompletionListCssClass="auto-complate-list" CompletionListHighlightedItemCssClass="auto-complate-hover" CompletionListItemCssClass="auto-complate-item" ID="txsearchcust_AutoCompleteExtender" runat="server" ServiceMethod="GetCompletionList" TargetControlID="txsearchcust" UseContextKey="True" CompletionListElementID="divwidthc" FirstRowSelected="false" EnableCaching="false" MinimumPrefixLength="1" CompletionSetCount="1" CompletionInterval="10" OnClientItemSelected="CustSelected">
                            </asp:AutoCompleteExtender>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                ...
                <div class="col-md-12">
                    <table class="mGrid" title="Invoice automatically selected with FIFO">
                        <tr>
                            ...
                            <th style="width: 5%">Qty&nbsp; Rtn</th>
                            <th style="width: 5%">Qty Avl</th>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:AutoCompleteExtender ID="txitemsearch_AutoCompleteExtender" CompletionListCssClass="input-sm" runat="server" TargetControlID="txitemsearch" CompletionInterval="10" CompletionSetCount="1" MinimumPrefixLength="1" EnableCaching="false" FirstRowSelected="false" ServiceMethod="GetCompletionList2" UseContextKey="True" OnClientItemSelected="ItemSelected">
                                        </asp:AutoCompleteExtender>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
            ...
            <ContentTemplate>
                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CellPadding="0" OnRowDataBound="grd_RowDataBound" OnRowEditing="grd_RowEditing" OnRowUpdating="grd_RowUpdating" OnRowDeleting="grd_RowDeleting" GridLines="None" ShowFooter="True" OnSelectedIndexChanging="grd_SelectedIndexChanging" CssClass="mGrid">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Amt Inclusive Vat">
                            <ItemTemplate>
                                <asp:Label ID="lbamtinclusivevat" runat="server" Text=""></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:Label ID="lbtotamtinclusivevat" runat="server" Text=""></asp:Label>
                            </FooterTemplate>
                        </asp:TemplateField>
    ...
    <div class="row">
        <div class="navi margin-bottom">
            <asp:Button ID="btrefresh" OnClientClick="ShowProgress();" runat="server" OnClick="btrefresh_Click" Text="refresh" Style="display: none" />
            <asp:Button ID="btcancel2" runat="server" CssClass="divhid" OnClick="btcancel2_Click" Text="Button" />
            <asp:Button ID="btnew" OnClientClick="ShowProgress();" runat="server" Text="New" CssClass="btn-success btn btn-new" OnClick="btnew_Click" />
            ...
            <asp:Button ID="btcancel" runat="server" CssClass="btn-danger btn btn-delete" Text="Cancel Return" OnClientClick="javascript:ConfirmDelete();return false;" OnClick="btcancel2_Click" />
