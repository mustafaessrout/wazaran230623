<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_cashregoutentry2.aspx.cs" Inherits="fm_cashregoutentry2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="form-horizontal">
            <h4 class="jajarangenjang">Cash In/Out Request</h4>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 drop-down">
                    <asp:DropDownList ID="cbinout" onchange="javascript:ShowProgress();" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbinout_SelectedIndexChanged">
                        <%--<asp:ListItem  runat="server" AutoPostBack="True" Selected="True" Value="HTE" Text="HO To Employee"></asp:ListItem>--%>
                    </asp:DropDownList>
                </div>
            ...
            <div class="row margin-bottom">
                ...
                <div class="col-md-2 require">
                    <div class="input-group-sm">
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txamt" CssClass="form-control require" runat="server" placeholder="Amount" AutoPostBack="true" OnTextChanged="txamt_TextChanged"></asp:TextBox>
                            </ContentTemplate>
                            <Triggers>
                ...
                <div class="col-md-2">
                    <div class="input-group-sm" style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="input-group-sm">
                            <asp:DropDownList ID="chvat" CssClass="form-control drop-down" runat="server" AutoPostBack="True" OnSelectedIndexChanged="chvat_SelectedIndexChanged">
                        ...
                        <div class="input-group-sm">
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                    <asp:Label ID="lbvat" CssClass="control-label" runat="server" Text="0" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:Label>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="chvat" EventName="SelectedIndexChanged" />
                                    <asp:AsyncPostBackTrigger ControlID="bttax" EventName="Click" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </div>
                    </div>
            ...
            <ContentTemplate>
            <div class="row margin-bottom" runat="server" id="showTax">
                <label class="control-label col-md-1">Tax</label>
                <div class="col-md-2">
                    <table class="mGrid">
                        <tr>
                            <th>Tax Name:</th>
                ...
                <div class="col-md-5">
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grdtax" CssClass="mGrid" runat="server" AutoGenerateColumns="False" CellPadding="0" EmptyDataText="No tax found" ShowHeaderWhenEmpty="True" OnRowDataBound="grdtax_RowDataBound" OnRowDeleting="grdtax_RowDeleting">
                                <Columns>
            ...
            <div class="row margin-bottom">
                <div class=" col-md-3" runat="server" id="vMunicipality">
                    <div class="input-group-sm" style="margin-left: -2px; width: 100%;">
                        <asp:UpdatePanel runat="server" style="display: flex; justify-content: space-between; width: 100%; align-items: center; margin-bottom: 0px;">
                            <ContentTemplate>
                                <asp:CheckBox ID="ckmunicipality" CssClass="control-label" runat="server" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Municipality Tax" AutoPostBack="true" OnCheckedChanged="ckmunicipality_CheckedChanged" />
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div id="DivPlate" runat="server">
                            <label class="control-label col-md-1">Plate No</label>
                            <div class="col-md-2 drop-down">
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlPlateNo" runat="server" CssClass="form-control"></asp:DropDownList>
                                        <%--<asp:TextBox ID="txPlateNo" CssClass="form-control ro" runat="server" placeholder=""></asp:TextBox>--%>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                            <label class="control-label col-md-2">Last Reading(KM)</label>
                            <div class="col-md-1">
                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                    <ContentTemplate>
                                        <asp:Label ID="lblLast" runat="server" Text="" ForeColor="Red" Font-Size="X-Large"></asp:Label>
                                        <%--<asp:TextBox ID="txPlateNo" CssClass="form-control ro" runat="server" placeholder=""></asp:TextBox>--%>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
            ...
            <div id="yellowLine2" runat="server" class="row margin-bottom" style="background-color: yellow; padding: 10px; margin-top: 10px;">
                <div class="col-md-2">
            ...
            <div class="row margin-bottom" style="text-align: center">
                <div class="col-md-12" style="text-align: center">
                    ...
                    <asp:Button ID="btsearchPlate" runat="server" Text="Button" OnClick="btsearchPlate_Click" CssClass="divhid" />
