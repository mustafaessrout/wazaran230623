...
public partial class fm_stockopnameentry : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void btprint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            arr.Add(new cArrayList("@stock_no", txstockno.Text));
            arr.Add(new cArrayList("@salespointcd", Request.Cookies["sp"].Value.ToString()));
            Session["lParamsop"] = arr;
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "go", "openreport('fm_report2.aspx?src=sop');", true);
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "sethid", "dvshow.setAttribute('class','divhid');", true);
