<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_takeorderentry2.aspx.cs" Inherits="fm_takeorderentry2" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            <div class="row margin-bottom" style="background-color: yellow">
                ...
                <label class="control-label col-md-1">Disc On-Off</label>
                <div class="col-md-2">
                ...
                <label class="control-label col-md-1">Paid Cash</label>
                <div class="col-md-2">
                ...
                <label class="control-label col-md-1">Direct Sales</label>
                <div class="col-md-2">
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" ID="txtabnoPnl" CssClass="input-group">
                                ...
                                <asp:Panel runat="server" CssClass="input-group-btn" ID="bttabsearchPnl">
                                    <button id="bttabsearch" class="btn btn-primary" type="submit" runat="server" onserverclick="bttabsearch_Click">
            ...
            <div class="row margin-bottom">
                ...
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbvehicle" CssClass="form-control" runat="server">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            ...
            <div class="row margin-bottom" runat="server" id="showProforma">
                <label class="col-md-1 control-label">Pro-Forma Invoice</label>
                <div class="col-md-4">
                            <div class="col-md-6">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                    <div class="clearfix">
                                        ...
                                        <div class="col-md-12 col-sm-6 clearfix no-padding">
            ...
            <div class="form-group">
                <div class="col-md-4 col-md-offset-8">
                    <table class="table tab-content">
                        <tr>
                            <th style="text-align: right; width: 50%">VAT <asp:Label ID="lbtitlevat" runat="server" Text="5"></asp:Label> % :                       
            ...
            <div class="form-group">
                <label class="control-label col-md-1">PO Cust</label>
                <div class="col-md-2">
...
يرجى كتابة كود أو اسم العميل
    ...
    <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
        ...
        <div class="body">
            ...
            <asp:Button ID="btsearch" runat="server" CssClass="button2 search" OnClick="btsearch_Click" OnClientClick="javascript:ShowProgress();" />
