...
using System.IO;
public partial class fm_accManualJournal_List : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (grd.Rows.Count == 0)
            {
                ...
                //Label viewJournal = (Label)e.Row.FindControl("viewJournal");
                //viewJournal.Text = "x";

                //Label l = (Label)e.Row.Cells[6].Controls[2];
                //l.Visible = false;
            }
        }
    }
    ...
    private void bindinggrd(Boolean hasApprovalRole, Boolean isEmptyGrid)
    {
        ...
        arr.Add(new cArrayList("@hasApprovalRole", hasApprovalRole));
        arr.Add(new cArrayList("@id_module", "MANUALJOURNAL"));
        arr.Add(new cArrayList("@isEmptyGridStr", isEmptyGridStr));
        bll.vBindingGridToSp(ref grd, "sp_journal_get", arr);
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "tabFix", "tabFix();", true);
        ...
        arr.Add(new cArrayList("@id_module", "MANUALJOURNAL"));
        //arr.Add(new cArrayList("@isEmptyGridStr", isEmptyGridStr));
        bll.vIsJournalEmptyGrid(arr, ref isEmptyGridStr);
    ...
    protected void btaddjournal_Click(object sender, EventArgs e)
    {
        Response.Redirect("fm_accManualJournal.aspx");
    }
}
