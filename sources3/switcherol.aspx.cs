...
public partial class switcherol : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (cbapps.Items.Count == 0)
            {
                ...
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "sweetAlert('You dont have access to Wazaran Apps!','Please contact Wazaran Admin for open access','error');", true);
                return;
            }
