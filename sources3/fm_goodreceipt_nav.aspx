<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_goodreceipt_nav.aspx.cs" Inherits="fm_goodreceipt_nav" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="row clearfix margin-bottom">
            <div class="clearfix col-md-8 col-sm-12 no-padding">
                ...
                <div class="col-sm-6  no-padding">
                    ...
                    <div class="col-sm-8">
                        <asp:TextBox ID="dtgoodreceipt" runat="server" CssClass="form-control input-sm ro" Enabled="False" ></asp:TextBox>
        ...
        <div class="row clearfix ">
            ...
            <div class="clearfix margin-bottom">
                <div class="clearfix col-sm-6  no-padding">
                    <label class="titik-dua control-label col-sm-4">GDN Date</label>
                    <div class="col-sm-8">
                        <asp:TextBox ID="dtgdn" runat="server" CssClass="form-control input-sm" Enabled="True" ></asp:TextBox>
                        <asp:CalendarExtender ID="dtgdn_CalendarExtender" runat="server" Format="d/M/yyyy" TargetControlID="dtgdn" TodaysDateFormat="d/M/yyyy">
                        </asp:CalendarExtender>
                    </div>
                </div>
            </div>
            ...
            <div class="clearfix margin-bottom">
                <div class="clearfix col-sm-6  no-padding">
                    <label class="titik-dua control-label col-sm-4">GDN No</label>
                    <div class="col-sm-8">
            ...
            <div class="clearfix margin-bottom">
                <div class="clearfix col-sm-6  no-padding">
                    <label class="titik-dua control-label col-sm-4">Manual No</label>
                    <div class="col-sm-8">
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txmanualno" runat="server" CssClass="form-control" Enabled="true"></asp:TextBox>
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btsearch" EventName="Click" />
                            </Triggers>
    ...
    <div class="divgrid">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <asp:GridView ID="grd_nav" CssClass="table table-striped mygrid" runat="server" AutoGenerateColumns="False" GridLines="None" CellPadding="0" OnRowDataBound="grd_nav_RowDataBound" ShowFooter="True">
                     <AlternatingRowStyle  />
                    <Columns>
                        <asp:TemplateField HeaderText="No.">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Item Code">
                            <ItemTemplate>
                                <asp:Label ID="lbitemcode" runat="server" Text='<%# Eval("DO_Item_2")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Item Name">
                            <ItemTemplate><asp:Label ID="lbitem_nm" runat="server" Text='<%# Eval("item_nm")%>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Size">
                            <ItemTemplate><asp:Label ID="lbsize" runat="server" Text='<%# Eval("size")%>'></asp:Label></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qty Shipment">
                            <ItemTemplate>
                                <div style="text-align: right;">
                                    <asp:Label ID="lbqtyshipment" runat="server" Text='<%# Eval("qty_conv")%>'></asp:Label>
                                    <asp:HiddenField ID="hdqtyshipment" runat="server" Value='<%#Eval("DO_qty") %>'></asp:HiddenField>
                                    <asp:HiddenField ID="hduomshipment" runat="server" Value='<%#Eval("uom") %>'></asp:HiddenField>
                                </div>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Qty Received">
                            <ItemTemplate>
                                <asp:HiddenField ID="hdqtyreceived" runat="server" Value='<%#Eval("DO_qty") %>'></asp:HiddenField>
                                <asp:HiddenField ID="hdqtyreceived_conv" runat="server" Value='<%#Eval("qty_conv") %>'></asp:HiddenField>
                                <asp:TextBox ID="txqty_ctn" runat="server" TextMode="Number" Width="20%" Text='<%#Eval("qty_ctn") %>'></asp:TextBox>
                                    <asp:DropDownList runat="server" ID="cbuom_ctn" style="background-color:#ffd800"></asp:DropDownList>
                                    <asp:TextBox ID="txqty_pcs" runat="server" TextMode="Number" Width="20%" Text='<%#Eval("qty_pcs") %>'></asp:TextBox>
                                <asp:DropDownList runat="server" ID="cbuom_pcs" style="background-color:#ffd800"></asp:DropDownList>
                            </ItemTemplate>
                            <FooterTemplate>
				                <div style="text-align: right;">
                        ...
                        <asp:TemplateField HeaderText="Bin Destination">
                            <ItemTemplate>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="cbdestination2" runat="server" Width="150px"></asp:DropDownList>
                                    </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="cbwarehouse" EventName="SelectedIndexChanged" />
                                </Triggers>
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="grddtl_nav" CssClass="table table-striped mygrid" runat="server" AutoGenerateColumns="False" CellPadding="0"  GridLines="None" OnRowDataBound="grddtl_nav_RowDataBound" ShowFooter="True" >
                    <AlternatingRowStyle />
                    <Columns>
                        <asp:TemplateField HeaderText="No.">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Item Code">
                            <ItemTemplate>
                                <asp:Label ID="lbitem_cd" runat="server" Text='<%# Eval("DO_Item_2") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Item Name">
                            <ItemTemplate>
                                <asp:Label ID="lbitem_nm" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Size">
                            <ItemTemplate>
                                <asp:Label ID="lbsize" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qty Shipment">
                            <ItemTemplate>
                                <div style="text-align: right;">
                                    <asp:Label ID="lblqty" runat="server" Text='<%# Eval("DO_qty")%>'></asp:Label>
                                </div>
                            </ItemTemplate>
                            <FooterTemplate>
                                <div style="text-align: right;">
                        ...
                        <asp:TemplateField HeaderText="UOM Shipment">
                            <ItemTemplate>
                                <div style="text-align: right;">
                                    <asp:Label ID="lbuomshipment" runat="server" Text='<%# Eval("DO_uom")%>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qty Received">
                            <ItemTemplate>
                                <div style="text-align: right;">
                                    <asp:Label ID="lblqty_received" runat="server" Width="50" Text='<%# Eval("DO_qty")%>'></asp:Label>
                                </div>
                            </ItemTemplate>
                            <FooterTemplate>
                                <div style="text-align: right;">
                        ...
                        <asp:TemplateField HeaderText="UOM Received">
                            <ItemTemplate>
                                <div style="text-align: right;">
                                    <asp:Label ID="lbuomreceived" runat="server" Text='<%# Eval("DO_uom")%>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Whs_cd">
                            <ItemTemplate>
                                <asp:Label ID="lbwhs_cd" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Bin_cd">
                            <ItemTemplate>
                                <asp:Label ID="lbbin_cd" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Expire Date">
                            <ItemTemplate>
