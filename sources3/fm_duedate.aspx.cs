...
public partial class fm_duedate : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void btprint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "op", "openreport('fm_report2.aspx?src=duedate&spcd=" + cbsalespointcd.SelectedValue.ToString() + "&dt=" + tx.Text + "');", true);
        }
        catch (Exception ex)
        {
            List<cArrayList> arr = new List<cArrayList>();
