<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_cndnNormal.aspx.cs" Inherits="fm_cndnNormal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="form-horizontal">
        <h4 class="jajarangenjang">CN DN Normal</h4>
        ...
        <div class="navi row margin-bottom">
            <asp:LinkButton ID="btnPrint" runat="server" CssClass="btn btn-primary" OnClick="btnPrint_Click">SOA Raw</asp:LinkButton>
        </div>
    </div>
