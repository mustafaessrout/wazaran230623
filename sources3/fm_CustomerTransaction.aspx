<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_CustomerTransaction.aspx.cs" Inherits="fm_CustomerTransaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="divheader">
        <h4 class="jajarangenjang">Customer Transaction</h4>
    </div>
            ...
            <div class="clearfix">
                ...
                <div class="clearfix text-right col-sm-12 no-padding-right">
                    <div class="col-md-12" style="text-align: center">
                        ...
                        <asp:Button ID="btsearchcust" runat="server" Text="Button" OnClick="btsearchcust_Click" Style="display: none" />
                    </div>
                </div>
            </div>
        </div>
