<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_salestargetsalespointView.aspx.cs" Inherits="fm_salestargetsalespointView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-fluid">
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CellPadding="0" GridLines="None" 
                        OnRowDataBound="grd_RowDataBound"  CssClass="table table-striped mygrid">
                        <AlternatingRowStyle />
                        <Columns>
        ...
        <div class="navi row margin-bottom">
            ...
            <asp:LinkButton ID="btnGenerate" runat="server" CssClass="btn btn-info btn-print" OnClick="btnGenerate_Click">Gererate Data Product wise</asp:LinkButton>
            <asp:LinkButton ID="btnAchievement" runat="server" CssClass="btn btn-info btn-print" OnClick="btnAchievement_Click">Achievement By Product</asp:LinkButton>
            <asp:LinkButton ID="btnAchievementAll" runat="server" CssClass="btn btn-info btn-print" OnClick="btnAchievementAll_Click">Achievement All Product</asp:LinkButton>
        </div>
    </div>
