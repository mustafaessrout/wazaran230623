...
public partial class fm_login2 : System.Web.UI.Page
{
    cbll bll = new cbll();
    protected void Page_Load(object sender, EventArgs e)
    {
        return;
        Response.Redirect("fm_login3.aspx");
        ...
        Response.Cookies["sp"].Value = "204";
        Response.Cookies["spn"].Value = "NO ACTIVEATED";
