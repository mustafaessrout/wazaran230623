<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_stockopnameentry.aspx.cs" Inherits="fm_stockopnameentry" %>
...
<div id="container">
    <h4 class="jajarangenjang">Stock Opname</h4>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="text-center margin-top">
                            <asp:Button ID="btgenerate" runat="server" CssClass="btn-success btn btn-add" OnClick="btgenerate_Click" Text="Show Item" Visible="true" />
                        </div>
                    ...
                    <asp:GridView ID="grditem" CssClass="mGrid" runat="server" AutoGenerateColumns="False" ShowFooter="False" CellPadding="0" OnRowDataBound="grditem_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Item">
                                <ItemTemplate>
                                    <asp:Label ID="lbitemcd" runat="server" Text='<%#Eval("item_cd") %>'></asp:Label> | <asp:Label ID="lbitemnm" runat="server" Text='<%#Eval("item_nm") %>'></asp:Label> | <asp:Label ID="lbitemsize" runat="server" Text='<%#Eval("size") %>'></asp:Label> | <asp:Label ID="lbitembranded" runat="server" Text='<%#Eval("branded_nm") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Qty System">
                                <ItemTemplate>
                                    <asp:Label ID="lbqtysys" runat="server" Text='<%#Eval("qty_system") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Qty Actual">
                                <ItemTemplate>
                                    <asp:TextBox ID="txqty" Text='<%#Eval("qty_actual") %>' runat="server"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
