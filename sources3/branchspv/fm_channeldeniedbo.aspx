<%@ Page Title="" Language="C#" MasterPageFile="~/branchspv/branchspv.master" AutoEventWireup="true" CodeFile="fm_channeldeniedbo.aspx.cs" Inherits="Adminbranch_fm_channeldeniedbo" %>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <tr><td>
                    ...
                    <td>
                        *)Add is mean this channel will be denied from Back Office Transaction, reversed for Deleted
                    </td>
                </tr>
