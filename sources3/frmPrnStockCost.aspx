<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmPrnStockCost.aspx.cs" Inherits="frmPrnStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="divheader">Print Stock Report Cost</div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="clearfix form-group">
                    <label class="control-label col-sm-2" hidden="hidden">UOM Based</label>
                    <div class="col-sm-10 drop-down">
                        <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbuom" runat="server" CssClass="form-control" Visible="False" >
                            </asp:DropDownList>
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
        ...
        <div class="navi row padding-bottom padding-top margin-top">
             ...
             <asp:Button ID="btexcel" runat="server" CssClass="btn-info btn btn-print" Text="Print Raw Data" OnClick="btexcel_Click" Visible="False" />
