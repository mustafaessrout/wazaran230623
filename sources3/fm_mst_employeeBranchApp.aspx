<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_mst_employeeBranchApp.aspx.cs" Inherits="fm_mst_employeeBranchApp" %>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2 require">
                <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtName" runat="server" Text="" CssClass="form-control input-sm ro"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            ...
            <div class="col-md-2">
                <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtNameArabic" Style="text-align: right;" runat="server" Text="" CssClass="form-control input-sm ro"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            ...
            <div class="col-md-2">
                <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                    <ContentTemplate>
                        <img src="www.vom" id="imgEmployeePhoto" runat="server" alt="photo" style="width: 103px; height: 60px;" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <div>
                ...
                <div class="col-md-2 ">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:HiddenField ID="hdfEmp_std" runat="server" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel55" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtVIN" runat="server" Text="" CssClass="form-control input-sm ro"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <label class="control-label col-md-1">Sample</label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 ">
                    <asp:UpdatePanel ID="UpdatePanel40" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtPlateArabic1" runat="server" Text="" CssClass="" Width="65" placeholder="١٢٣١"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <div style="display: none;">
                  ...
                  <asp:LinkButton ID="btprintEmp" CssClass="btn-info btn" runat="server" OnClick="btprintEmp_Click">Print</asp:LinkButton>
            </div>
