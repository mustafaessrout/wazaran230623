<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_claimconfirmCNDN.aspx.cs" Inherits="fm_claimconfirmCNDN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="divheader">Claim Daily Confirmation CNDN</div>
                                ...
                                <asp:GridView ID="grdCLAIM" runat="server" CssClass="table table-striped table-page-fix  table-bordered table-fix table-hover" OnPageIndexChanging="grdCLAIM_PageIndexChanging" data-table-page="#copy-fst" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" EmptyDataText="No Data Found" OnRowDataBound="grdCLAIM_RowDataBound" AllowPaging="True" PageSize="30">
                                    <Columns>
                                        <asp:TemplateField HeaderText="CNDN No.">
                                            <ItemTemplate>
                                                <asp:UpdatePanel UpdateMode="Conditional" ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <asp:LinkButton ID="lnkinv" runat="server" OnClientClick='<%#  String.Format("return OpenPop(\"{0}\",\"{1}\",\"{2}\",\"{3}\")","fm_invoiceinfoCNDN.aspx","newWindow","scrollbars=yes,resizable=yes", Eval("cndn_cd").ToString().Trim()) %>'>
                                                            <asp:Label ID="lbcndn" runat="server" Text='<%# Eval("cndn_cd") %>'></asp:Label>
                                                        </asp:LinkButton>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <asp:TemplateField HeaderText="SIGNATURE">
                                            <ItemTemplate>
                                                <asp:UpdatePanel UpdateMode="Conditional" ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="approve" runat="server" value='<%# Eval("cndn_cd") %>' AutoPostBack="true" OnCheckedChanged="chapprove_CheckedChanged"></asp:CheckBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <asp:TemplateField HeaderText="STAMP">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chsign" runat="server" value='<%# Eval("cndn_cd") %>'></asp:CheckBox></a> 
                                            </ItemTemplate>
                                        </asp:TemplateField>
