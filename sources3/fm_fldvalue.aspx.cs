...
public partial class fm_fldvalue : System.Web.UI.Page
{
    cbll bll = new cbll();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                arr.Add(new cArrayList("@fld_nm", "masterdata"));
            ...
            catch (Exception ex)
            {
                ...
                bll.vHandledError(ref ex, Request.Cookies["sp"].Value.ToString()+" : fm_fldvalue");
