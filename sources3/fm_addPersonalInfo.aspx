<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="fm_addPersonalInfo.aspx.cs" Inherits="fm_addPersonalInfo" %>
...
<body class="login4 center middle" style="height:100%;">
    ...
    <div class="content">
       ...
       <form id="frm" runat="server" class="login-form">
           <h3 class="title text-center">Add Personal Information</h3>
        ...
        <div class="login-inputs">
                <label class="control-label col-sm-12" style="padding-top: 17px;">Enter Your Birth Date:</label>   
                      ...
                      <div class="border-white tops control-label col-sm-12 no-padding">
                    <div class="border-white bottoms drop-down-date" style="margin-bottom:20px" >
