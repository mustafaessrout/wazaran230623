<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_contractKA.aspx.cs" Inherits="fm_contractKA" %>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="dateInserted" class="col-xs-4 col-form-label col-form-label-sm">Date.</label>
                                        <div class="col-xs-6">
                                            <asp:TextBox ID="dtCrDate" runat="server" CssClass="form-control input-sm" ></asp:TextBox>
                                            <asp:CalendarExtender CssClass="date" ID="dtCrDate_CalendarExtender" runat="server" BehaviorID="dtCrDate_CalendarExtender" Format="d/M/yyyy" TargetControlID="dtCrDate">
                                        ...
                                        <asp:GridView ID="grdProposal" AllowPaging="True" OnRowDeleting="grdProposal_RowDeleting" runat="server"  CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Date">
                                                    <ItemTemplate><%#Eval("created_dt") %></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate><%#Eval("amount") %></ItemTemplate>
                                                </asp:TemplateField>
    ...
    <div class="row margin-bottom">
          <div class="col-sm-12">
            <div class="text-center navi">
                ...
                <asp:Button ID="btupdate" runat="server" Text="Update" CssClass="btn-warning  btn btn-save" OnClick="btupdate_Click" />
                <asp:Button ID="btdelete" runat="server" Text="Delete" CssClass="btn-warning  btn btn-save" OnClick="btdelete_Click" />
