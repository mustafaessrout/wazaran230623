<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_lookupitemcash.aspx.cs" Inherits="fm_lookupitemcash" %>
...
<body style="font-family:Tahoma,Verdana;font-size:small">
    ...
    <div class="auto-style1">
      ...
      <div style="padding:10px 10px 10px 10px">
          Warehouse : <asp:DropDownList ID="cbwhs" runat="server" OnSelectedIndexChanged="cbwhs_SelectedIndexChanged" AutoPostBack="True" Width="10em"></asp:DropDownList> | Bin : <asp:DropDownList ID="cbbin" runat="server" OnSelectedIndexChanged="cbbin_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList> | UOM :<asp:DropDownList ID="cbuomfree" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbuomfree_SelectedIndexChanged" Width="10em">
          </asp:DropDownList>
<table><tr><td class="auto-style2"><p>Maximum Discount : <strong><asp:Label ID="lbbaldiscount" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></strong> </p></td><td class="auto-style2"><asp:Label ID="lbuomfree" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></td></tr></table>
      </div>
        <div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Stock">
                        <ItemTemplate>
                            <asp:Label ID="lbstock" runat="server" Text="0"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
