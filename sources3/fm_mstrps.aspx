<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_mstrps.aspx.cs" Inherits="fm_mstrps" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <%--   <div class="divheader">RPS Entry</div>
    ...
    <div class="alert alert-info text-bold">RPS Entry</div>
                                ...
                                <div class="well well-sm clearfix">
                                    ...
                                    <div class="col-sm-12 ">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" class="">
                                            <ContentTemplate>
                                                <asp:Label ID="lbdate" runat="server" Text="Date" CssClass="col-sm-1 control-label margin-bottom"></asp:Label>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>

                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" class="drop-down-date col-sm-5">
                                            <ContentTemplate>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdbydate" runat="server" AutoGenerateColumns="False" CssClass="table table-striped mygrid" GridLines="None">
                    <AlternatingRowStyle />
                    <Columns>
