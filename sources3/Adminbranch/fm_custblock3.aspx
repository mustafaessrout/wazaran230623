<%@ Page Title="" Language="C#" MasterPageFile="~/adminbranch/admbranch.master" AutoEventWireup="true" CodeFile="fm_custblock3.aspx.cs" Inherits="admin_fm_custblock3" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="adminbranch/css/bootstrap.css" rel="stylesheet" />
    <script src="adminbranch/js/bootstrap.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainholder" Runat="Server">
    ...
    <div class="form-group">
                ...
                <div class="col-md-2">
                   <asp:DropDownList ID="cbcustcate_cd" runat="server" Width="100%"  OnSelectedIndexChanged="cbcustcate_cd_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                </div>
