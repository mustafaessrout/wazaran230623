<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_invoiceinfoCNDN.aspx.cs" Inherits="fm_invoiceinfoCNDN" %>
...
<body style="font-family: Calibri; font-size: small;">
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div style="background-color: silver; padding: 1em 1em 1em 1em">
            <strong>CNDN Information
            </strong>
        </div>
        <table style="width: 100%">
            <tr>
                <td class="auto-style2">CNDN NO</td>
                <td>:</td>
                <td class="auto-style1">
                    <asp:Label ID="lbcndn" runat="server" Style="font-weight: 700"></asp:Label></td>
                <td>Proposal No</td>
                <td>:</td>
                <td>
            ...
            <tr>
                ...
                <td>:</td>
                <td class="auto-style1">
                    <asp:Label ID="lbcontract" runat="server"></asp:Label>
                </td>

                <td class="auto-style2">CNDN Date</td>
                <td>:</td>
                <td class="auto-style4">
                    <asp:Label ID="lbcndndt" runat="server" Text=""></asp:Label>
                </td>

            </tr>            
            <tr>
                <td style="text-align: left; vertical-align: top" class="auto-style3">CNDN Detail</td>
                <td style="vertical-align: top">:</td>
                <td colspan="4" style="vertical-align: top">
                    <%# Eval("salespointcd") %>
                    <asp:GridView ID="grdcndn" runat="server" AutoGenerateColumns="False" CellPadding="0" ForeColor="#333333" GridLines="None" Width="100%" EmptyDataText="NO DATA" CssClass="mygrid">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:TemplateField HeaderText="CNDN Code">
                                <ItemTemplate>
                                    <asp:Label ID="lbco" runat="server" Text='<%# Eval("cndn_cd") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
