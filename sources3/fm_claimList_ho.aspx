<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_claimList_ho.aspx.cs" Inherits="fm_claimList_ho" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        function OpenDetails(claim_no) {
            window.open("fm_invByProposal_ho.aspx?number=" + claim_no);
        }
    </script>
    <style type="text/css">
        .auto-style1 {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="divheader">Claim List HO</div>
    ...
    <div class="container">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddtype" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddtype_SelectedIndexChanged" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="IV">PRO-FORMA INVOICES</asp:ListItem>
                                    <asp:ListItem Value="CSH">PRO-FORMA CASHOUT</asp:ListItem>
                                    <asp:ListItem Value="BA">CREDIT MEMO</asp:ListItem>
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
        ...
        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
                <div class="overflow-y" style="max-height:250px; width:100%;">
                    <asp:Label ID="lblInvoice" runat="server" Text="Claim Pro-Forma Invoice" Font-Bold="true" ></asp:Label>
                    <asp:GridView ID="gridClaim" runat="server" AutoGenerateColumns="False" ShowFooter="True" CellPadding="4" GridLines="None" PageSize="15" CssClass="table table-striped table-hover table-fix mygrid">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Free Cash">
                                <ItemTemplate>
                                    <asp:Label ID="freevalue" runat="server" Text='<%# Eval("freevalue","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Free Qty">
                                <ItemTemplate>
                                    <asp:Label ID="freeqty" runat="server" Text='<%# Eval("freeqty","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
            <ContentTemplate>
                <div class="overflow-y" style="max-height:250px; width:100%;">
                    <asp:Label ID="lblCashout" runat="server" Text="Claim Pro-Forma Cashout" Font-Bold="true" ></asp:Label>
                    <asp:GridView ID="grdclaimcashout" runat="server" AutoGenerateColumns="False" ShowFooter="True"  GridLines="None" CssClass="table table-striped table-hover table-fix mygrid" PageSize="15">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Free Cash">
                                <ItemTemplate>
                                    <asp:Label ID="freevalue" runat="server" Text='<%# Eval("ordervalue","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
            <ContentTemplate>
                <div class="overflow-y" style="max-height:250px; width:100%;">
                    <asp:Label ID="lblContract" runat="server" Text="Claim CM HO" Font-Bold="true" ></asp:Label>
                    <asp:GridView ID="grdclaimcontract" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass="table table-striped table-hover table-fix mygrid" GridLines="None" PageSize="15">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Amount">
                                <ItemTemplate>
                                    <asp:Label ID="amount" runat="server" Text='<%# Eval("amount","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
