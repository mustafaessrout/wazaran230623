<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="gclmdoc.aspx.cs" Inherits="gclmdoc" %>
...
<asp:Button ID="btgn" runat="server" OnClick="btgn_Click" Text="Generate" />
&nbsp;
