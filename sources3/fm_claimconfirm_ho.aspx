<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_claimconfirm_ho.aspx.cs" Inherits="fm_claimconfirm_ho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="divheader">Invoice HO Daily Confirmation</div>
                            ...
                            <div class="overflow-y" style="max-height:320px; width:100%;">
                                <asp:GridView ID="grdCLAIM" runat="server" CssClass="table table-striped table-page-fix  table-bordered table-fix table-hover" OnPageIndexChanging="grdCLAIM_PageIndexChanging" data-table-page="#copy-fst" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" EmptyDataText="No Data Found" OnRowDataBound="grdCLAIM_RowDataBound" AllowPaging="True" PageSize="30">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Invoice No.">
                                            <ItemTemplate>
                                                <asp:UpdatePanel UpdateMode="Conditional" ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <asp:LinkButton ID="lnkinv" runat="server" OnClientClick='<%#  String.Format("return OpenPop(\"{0}\",\"{1}\",\"{2}\",\"{3}\",\"{4}\",\"{5}\")","fm_invoiceinfo_ho.aspx","newWindow","scrollbars=yes,resizable=yes", Eval("inv_no").ToString().Trim()) %>'>
                                        ...
                                        <asp:BoundField DataField="inv_dt" HeaderText="INVOICE DATE" DataFormatString="{0:d/M/yyyy}" />
                                        ...
                                        <asp:TemplateField HeaderText="SIGNATURE">
                                            <ItemTemplate>
                                                <asp:UpdatePanel UpdateMode="Conditional" ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="approve" runat="server" value='<%# Eval("inv_no") %>' AutoPostBack="true" OnCheckedChanged="chapprove_CheckedChanged"></asp:CheckBox>
                                                    </ContentTemplate>
                                                    <Triggers>
                                        ...
                                        <asp:TemplateField HeaderText="STAMP">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chsign" runat="server" value='<%# Eval("inv_no") %>'></asp:CheckBox></a> 
                                            </ItemTemplate>
                                        </asp:TemplateField>
