<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_reqdiscount2.aspx.cs" Inherits="fm_reqdiscount2" %>
    ...
    <div class="bd-example">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <ContentTemplate>
                <div class="table-responsive">
                    <asp:GridView ID="grdviewgroup" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found">  
                        <Columns>
                            <asp:TemplateField HeaderText="Group Code">
                            <ItemTemplate>
                    ...
                    <asp:GridView ID="grdviewitem" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found">  
                        <Columns>
