<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lookupreqdiscount_ho.aspx.cs" Inherits="lookupreqdiscount_ho" %>
        ...
        <div style="font-family: Calibri; font-size: small">
            <table>
                <tr>
                    ...
                    <th>
                        <asp:DropDownList ID="cbbranch" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbbranch_SelectedIndexChanged">
                        </asp:DropDownList>
                    </th>
                    <th>
