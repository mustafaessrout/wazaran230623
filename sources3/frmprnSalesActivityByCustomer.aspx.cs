...
public partial class frmprnSalesActivityByCustomer : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void btprint_Click(object sender, EventArgs e)
    {
        ...
        Session["lParamSalesActivityByCustomer"] = arr;
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "go", "openreport('fm_report2.aspx?src=SalesActivityByCustomer');", true);
