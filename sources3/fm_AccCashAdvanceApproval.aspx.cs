...
public partial class fm_AccCashAdvanceApproval : System.Web.UI.Page
{
    ...
    protected void btapprove_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("landingpage3.aspx?src=cashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=A" + "&appBy=" + userid);
        }
        else if (lblDocNo.Text.ToString().Replace("Document No : ", "").Substring(0, 3) == "CAD")
        {
            Response.Redirect("landingpage3.aspx?src=PettycashCashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=A" + "&appBy=" + userid);
        }
        else if (lblDocNo.Text.ToString().Replace("Document No : ", "").Substring(0, 3) == "CLP")
        {
            Response.Redirect("landingpage3.aspx?src=ClaimCashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=A" + "&appBy=" + userid);
        }
    ...
    protected void btreject_Click(object sender, EventArgs e)
    {
        ...
        if (lblDocNo.Text.ToString().Replace("Document No : ", "").Substring(0, 2) == "CO")
        {
            Response.Redirect("landingpage3.aspx?src=cashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=R"+ "&appBy=" + userid);
        }
        else if (lblDocNo.Text.ToString().Replace("Document No : ", "").Substring(0, 3) == "CAD")
        {
            Response.Redirect("landingpage3.aspx?src=PettycashCashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=R" + "&appBy=" + userid);
        }
        else if (lblDocNo.Text.ToString().Replace("Document No : ", "").Substring(0, 3) == "CLP")
        {
            Response.Redirect("landingpage3.aspx?src=ClaimCashout&salespointcd=" + salespoint + "&ids=" + lblDocNo.Text.ToString().Replace("Document No : ", "") + "&sta=R" + "&appBy=" + userid);
        }
        //Response.Redirect("fm_AccCashAdvanceApproval_List.aspx");
    }
