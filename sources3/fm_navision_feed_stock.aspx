<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_navision_feed_stock.aspx.cs" Inherits="fm_navision_feed_stock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="alert alert-info text-bold">Navision Feed Interface (STOCKS)</div>
    <div class="container">
