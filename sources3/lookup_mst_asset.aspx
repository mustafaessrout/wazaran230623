                    ...
                    <div class="form-group">
                        <table>
                            <tr<%-->
                                ...
                                <td>
                                    <asp:DropDownList ID="cbsalespoint" AutoPostBack="true" OnSelectedIndexChanged="cbsalespoint_SelectedIndexChanged" CssClass="form-control" runat="server" Style="width: 76%;">
                                    </asp:DropDownList>
                                </td>
                            </tr>--%>
                            <tr>
                                <td>Asset Type</td>
                                <td>
                                    <asp:DropDownList ID="cbAsset_type" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cbAsset_type_SelectedIndexChanged" runat="server" Style="width: 76%;"></asp:DropDownList>
                            ...
                            <tr style="display: none;">
                                <td>Serach By ID Or Name
                                </td>
                                <td>
                                    <asp:TextBox ID="txsearch" runat="server" CssClass="form-control" Style="width: 76%;"></asp:TextBox>
