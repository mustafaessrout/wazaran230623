<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_invoiceinfoBA.aspx.cs" Inherits="fm_invoiceinfoBA" %>
...
<body style="font-family: Calibri; font-size: small;">
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div style="background-color: silver; padding: 1em 1em 1em 1em">
            <strong>Business Agreement Information
            </strong>
        </div>
        <table style="width: 100%;">
            ...
            <tr>
                <td class="auto-style2">Contract Type</td>
                <td>:</td>
                <td class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">Payment Date</td>
                <td>:</td>
                <td class="auto-style1">
            ...
            <tr style="display: none;">
                <td style="display: none;">Free Manual_no</td>
                <td>:</td>
                <td style="display: none;">
                    <asp:Label ID="lbfree" runat="server"></asp:Label>
                </td>
                <td style="display: none">Discount No</td>
                <td>:</td>
                ...
                <td colspan="4" style="vertical-align: top">
                    ...
                    <asp:GridView ID="grdinvoice" runat="server" AutoGenerateColumns="False" CellPadding="0" ForeColor="#333333" GridLines="None" Width="100%" EmptyDataText="NO DATA" CssClass="mygrid" OnRowCancelingEdit="grdinvoice_RowCancelingEdit" OnRowEditing="grdinvoice_RowEditing" OnRowUpdating="grdinvoice_RowUpdating">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty">
                                <ItemTemplate>
                                    <div style="text-align: right;">
                                        <asp:Label ID="lbqty" runat="server" Text='<%# Eval("amount") %>'></asp:Label>
                                    </div>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txqty" runat="server" Text='<%# Eval("amount") %>' Width="4em"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            ...
                            <%--<asp:BoundField DataField="disc_amt" HeaderText="Disc" />sd--%>
                            <%--<asp:TemplateField HeaderText="Qty">
                            <ItemTemplate>
                                <div style="text-align: right;">
        ...
        <table>
            <tr>
                ...
                <td colspan="4" style="vertical-align: top" class="navi">&nbsp;</td>
            </tr>
            <div id="orderUpload" runat="server">
                <tr>
                    <td style="text-align: left; vertical-align: top" class="auto-style3">
                        <asp:Label ID="lbupinv" runat="server" Text="Order Business Agreement" ></asp:Label>
                    </td>
                    <td style="vertical-align: top" class="auto-style1">:</td>
            ...
            <div id="freeUpload" runat="server" style="display: none;">
                <tr>
                    <td style="text-align: left; vertical-align: top" class="auto-style3">
