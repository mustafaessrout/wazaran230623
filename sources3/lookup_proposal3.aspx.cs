...
public partial class lookup_proposal3 : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    void vBindingGrid()
    {
        ...
        bll.vBindingGridToSp(ref grd, "sp_getProposacndn", arr);
    ...
    protected void btsearch_Click(object sender, EventArgs e)
    {
        ...
        arr.Add(new cArrayList("@month", Request.QueryString["month"]));
        arr.Add(new cArrayList("@year", Request.QueryString["year"]));
        bll.vBindingGridToSp(ref grd, "sp_getProposacndn_get", arr);
    }
