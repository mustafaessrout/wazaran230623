<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_acccndnAdjustmentReport.aspx.cs" Inherits="fm_acccndnAdjustmentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="form-horizontal">
        <h4 class="jajarangenjang">CN DN Adjustment Report</h4>
        ...
        <div class="navi row margin-bottom">
           ...
           <%-- <asp:LinkButton ID="btnInvoice" runat="server" CssClass="btn btn-primary" OnClick="btnInvoice_Click">Print Invoice Report</asp:LinkButton>--%>
            ...
            <asp:LinkButton ID="btnPrintCNDNHO" runat="server" CssClass="btn btn-primary" OnClick="btnPrintCNDNHO_Click">Print CNDN HO</asp:LinkButton>
        </div>
    </div>
