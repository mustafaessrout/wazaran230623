<%@ Page Title="" Language="C#" MasterPageFile="site.master" AutoEventWireup="true" CodeFile="fm_mst_assetPurchase.aspx.cs" Inherits="fm_mst_assetPurchase" %>
    ...
    <script>
        $(document).ready(function () {
           <%-- $("#<%=btsearch.ClientID%>").click(function () {
            ...
            $("#<%=txtNewAssetPurchaseAmount.ClientID%>").keydown(function (e) {
            ...
            $("#<%=txtOldAssetPurchaseAmount.ClientID%>").keydown(function (e) {
                // Allow: backspace, delete, tab, escape, enter and .
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                    // Allow: Ctrl+A, Command+A
                    (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) ||
            ...
            $("#<%=txtPurchaseQty.ClientID%>").keydown(function (e) {
                // Allow: backspace, delete, tab, escape, enter and .
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
                    // Allow: Ctrl+A, Command+A
                    (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) ||
        ...
        function AssetSelected(sender, e) {
            $get('<%=hdAssetNo.ClientID%>').value = e.get_value();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-horizontal" style="font-family: Calibri; font-size: small">
        <h4 class="jajarangenjang">Purchase</h4>
        ...
        <div class="form-group">
                ...
                <div class="input-group">
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:AutoCompleteExtender ID="txsearchcust_AutoCompleteExtender" runat="server" ServiceMethod="GetAssetList" TargetControlID="txtAssetCode"
                                UseContextKey="True" MinimumPrefixLength="1" EnableCaching="false" FirstRowSelected="false" CompletionInterval="10"
                                CompletionSetCount="1" ShowOnlyCurrentWordInCompletionListItem="true" OnClientItemSelected="AssetSelected">
                            </asp:AutoCompleteExtender>
                            <asp:HiddenField ID="hdAssetNo" runat="server" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
            ...
            <div class="col-md-2">
                <asp:DropDownList ID="ddlSupplier" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
            ...
            <label class="control-label col-md-1" runat="server" id="Label1">Purchase Qty</label>
            <div class="col-md-2">
                <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtPurchaseQty" OnTextChanged  ="txtPurchaseQty_TextChanged" AutoPostBack="true" runat="server" MaxLength="12" CssClass="form-control input-sm"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-1">Is Old Asset</label>
            <div class="col-md-2">
                <asp:RadioButton ID="rbOldAsset" runat="server" GroupName="isOldAsset" Text="Old Asset" Checked="true" AutoPostBack="true" OnCheckedChanged="rbisOldAsset_CheckedChanged" />
                <asp:RadioButton ID="rbNewAsset" runat="server" GroupName="isOldAsset" Text="New Asset" Checked="false" AutoPostBack="true" OnCheckedChanged="rbisOldAsset_CheckedChanged" />
            </div>
            <div id="dvOldPurchase" runat="server">
                <label class="control-label col-md-1" runat="server" id="lblAssetDate">Old Asset Purchase Date(Optional))</label>
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtOldAssetPurchaseDate" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender1" CssClass="date" runat="server" TargetControlID="txtOldAssetPurchaseDate" Format="d/M/yyyy">
                            </asp:CalendarExtender>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <label class="control-label col-md-1" runat="server" id="lblAssetAmount">Old Asset Purchase Amount(Optional)/Qty</label>
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtOldAssetPurchaseAmount" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
            <label class="control-label col-md-1" runat="server" id="Label2">Purchase Amount</label>
            <div class="col-md-2">
                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtPurchaseAmount" runat="server" Enabled="false" CssClass="form-control input-sm"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        <div class="form-group">
            <div id="dvNewPurchase" runat="server">
                <label class="control-label col-md-1"></label>
                <div class="col-md-2">
                </div>
                <label class="control-label col-md-1">New Asset Purchase Date</label>
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtNewAssetPurchaseDate" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender2" CssClass="date" runat="server" TargetControlID="txtNewAssetPurchaseDate" Format="d/M/yyyy">
                            </asp:CalendarExtender>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <label class="control-label col-md-1">New Asset Purchase Amount)/Qty</label>
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtNewAssetPurchaseAmount" runat="server" OnTextChanged  ="txtPurchaseQty_TextChanged" AutoPostBack="true" CssClass="form-control input-sm"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
