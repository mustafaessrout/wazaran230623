...
public partial class fm_kpitargetProductSupervisor : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            bll.vBindingComboToSp(ref cbemployee, "sp_tmst_employee_getProductSupervisor", "emp_cd", "emp_desc", arr);
        }
    }
