<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_mstkpi.aspx.cs" Inherits="fm_mstkpi" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 drop-down">
                    <asp:DropDownList ID="cbkr"  CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbkr_SelectedIndexChanged"></asp:DropDownList>
                </div>
                <label class="control-label col-md-1">Section</label>
                <div class="col-md-2 drop-down">
                    <asp:DropDownList ID="cbsection"  CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbsection_SelectedIndexChanged"></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grd" CssClass="mGrid" runat="server" AutoGenerateColumns="False" OnRowDeleting="grd_RowDeleting" OnRowEditing="grd_RowEditing" OnRowCancelingEdit="grd_RowCancelingEdit" OnRowUpdating="grd_RowUpdating" 
            ...
            <div class="form-group">
                <div class="col-md-12" style="text-align: center; height: 20px;">
                    ...
                    <asp:LinkButton ID="btsave" runat="server"  CssClass="btn btn-danger" OnClick="btsave_Click"><i class="fa fa-save">&nbsp;Save</i></asp:LinkButton>
