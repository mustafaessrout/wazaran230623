...
public partial class fm_hrdpaHOArabic : System.Web.UI.Page
{
    cbll bll = new cbll();
    cdal cdl = new cdal();
    ...
    void vInitGrid()
    {
        ...
        bll.vBindingGridToSp(ref grd, "sp_trpt_hrd_kpiresultdtl_getArabic", arr);
    }
    protected void btprint_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "openreport('fm_report2.aspx?src=paArabic&emp="
