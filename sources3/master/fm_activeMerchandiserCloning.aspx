<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_activeMerchandiserCloning.aspx.cs" Inherits="fm_activeMerchandiserCloning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainholder" runat="Server">
    <div class="container">
        <div class="form-horizontal">
            ...
            <h4 class="jajarangenjang">Cloining Merchandiser Active</h4>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <label class="control-label col-sm-1">From Period</label>
                    <div class="col-sm-3 drop-down">
                        <asp:DropDownList ID="ddlPeriodFrom" runat="server" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                    <label class="control-label col-sm-1">To Period</label>
                    <div class="col-sm-3 drop-down">
                        <asp:DropDownList ID="ddlPeriodTo" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPeriodTo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row navi padding-bottom padding-top margin-bottom" style="text-align: center;">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        <asp:LinkButton ID="btUpdate" OnClick="btUpdate_Click" runat="server" CssClass="btn btn-primary">Clone</asp:LinkButton>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <div class="form-group">
