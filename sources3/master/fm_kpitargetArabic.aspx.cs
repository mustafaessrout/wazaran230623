...
public partial class fm_kpitargetArabic : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    protected void btsave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                arr.Add(new cArrayList("@period", cbperiod.SelectedValue.ToString()));
                arr.Add(new cArrayList("@qty", bll.vLookUp("select qty from thrd_kpi_target where ids='" + hdids.Value.ToString() + "' and emp_cd='" + cbemployee.SelectedValue.ToString() + "' and period='" + cbperiod.SelectedValue.ToString() + "'")));
                arr.Add(new cArrayList("@target_desc", "-"));
                bll.vInsertHRDKPITarget(arr);
            }
