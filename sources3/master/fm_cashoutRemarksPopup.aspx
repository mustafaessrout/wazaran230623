<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_cashoutRemarksPopup.aspx.cs" Inherits="fm_cashoutRemarksPopup" %>
...
<body style="font-family: Tahoma,Verdana; font-size: small">
    ...
    <form id="form1" runat="server">
        ...
        <div class="div-table">
            ...
            <strong>Cashout Remarks Mapping</strong>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-6" >Remarks</div>
                    <div class="col-md-10 col-sm-6">
                                ...
                                <asp:GridView ID="grd" OnRowDeleting="grd_RowDeleting" OnSelectedIndexChanging="grd_SelectedIndexChanging" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="1"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Remarks ">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdsequenceno" Value='<%# Eval("sequenceno") %>' runat="server" />
                                                <asp:HiddenField ID="hdfitemco_cd" Value='<%# Eval("itemco_cd") %>' runat="server" />
                                                <asp:Label ID="lbAttributeName" runat="server" Text='<%# Eval("Remark") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
