<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_hrdpaHOBSV.aspx.cs" Inherits="fm_hrdpaHOBSV" %>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center">
                        ...
                        <asp:LinkButton ID="bprint" CssClass="btn btn-danger" runat="server" OnClick="btprint_Click" Visible="false"><i class="fa fa-print">&nbsp;Print PA</i></asp:LinkButton>
                        ...
                        <asp:LinkButton ID="btValidationSheet" CssClass="btn btn-danger" runat="server" OnClick="btValidationSheet_Click"><i class="fa fa-print">&nbsp;Print Validation Sheet</i></asp:LinkButton>
