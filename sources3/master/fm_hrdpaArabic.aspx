<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_hrdpaArabic.aspx.cs" Inherits="fm_hrdpaArabic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="form-horizontal">
            <h4 class="jajarangenjang">تقييم الأداء</h4>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <label class="control-label col-md-1">نقاط القوة<span style="color:red;">*</span></label>
                    <div class="col-md-2">
                    ...
                    <label class="control-label col-md-1">نقاط الضعف<span style="color:red;">*</span></label>
                    <div class="col-md-2">
                    ...
                    <label class="control-label col-md-1">برنامج التطوير<span style="color:red;">*</span></label>
                    <div class="col-md-2">
