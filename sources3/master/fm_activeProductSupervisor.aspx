<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_activeProductSupervisor.aspx.cs" Inherits="fm_activeProductSupervisor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainholder" runat="Server">
    <div class="container">
        <div class="form-horizontal">
            ...
            <h4 class="jajarangenjang">Active Product Supervisor</h4>
            <div class="h-divider"></div>
            <div class="form-group">
                <div class="row">
                    <label class="control-label col-sm-1">Period</label>
                    <div class="col-sm-3 drop-down">
                        <asp:DropDownList ID="ddlPeriod" AutoPostBack="true"     runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlPeriod_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
                                        ...
                                        <asp:GridView ID="grd"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Emp Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEmpName" runat="server" Text='<%#Eval("emp_nm") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Product Code">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProductCode" runat="server" Text='<%#Eval("prod_cd") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Product Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblProductName" runat="server" Text='<%#Eval("prod_nm") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>                                               
                                                <asp:TemplateField>
                                                    <ItemTemplate>
            ...
            <div class="row navi padding-bottom padding-top margin-bottom" style="text-align: center;">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    <ContentTemplate>
                        <asp:LinkButton ID="btUpdate" OnClick="btUpdate_Click" runat="server" CssClass="btn btn-primary">Update</asp:LinkButton>
                        <asp:LinkButton ID="btView" OnClick="btView_Click" runat="server" CssClass="btn btn-danger">View Active Merchandiser</asp:LinkButton>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
