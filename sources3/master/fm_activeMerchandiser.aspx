<%@ Page Title="" Language="C#" MasterPageFile="~/master/homaster.master" AutoEventWireup="true" CodeFile="fm_activeMerchandiser.aspx.cs" Inherits="fm_activeMerchandiser" %>
                                    ...
                                    <div class="overflow-y relative" >
                                        <asp:GridView ID="grd"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chkIsTeamLeader" runat="server"  />
                                                    </ItemTemplate>
