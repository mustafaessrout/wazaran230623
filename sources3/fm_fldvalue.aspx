<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_fldvalue.aspx.cs" Inherits="fm_fldvalue" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <%--<link href="../Content/Content/beatifullcontrol.css" rel="stylesheet" />--%>
                ...
                <div class="col-md-12">
                    <table class="table tab-pane">
                        ...
                        <tr><td>
                            ...
                            <td><asp:TextBox ID="txarabic" runat="server" CssClass="form-control"></asp:TextBox></td>
                            <td>
