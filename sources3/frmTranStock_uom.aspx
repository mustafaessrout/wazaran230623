<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmTranStock_uom.aspx.cs" Inherits="frmTranStock_uom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="alert alert-info text-bold">Destroy , Add and Lose</div>
    <div class="container">
        <div class="row">
            <div class="clearfix">
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                      <table class="table table-striped mygrid table-title-left row-no-padding">
                            <tr >
                                <th>Item Name</th>
                                <%--<th>UOM</th>--%>
                                <th colspan ="4" style="vertical-align: middle">Quantity</th>
                                <%--<th>Quantity</th>--%>
                                <th>Price</th>
                                <th>Action</th>
                            </tr>
                            <tr>
                                <td  style="width: 150px; vertical-align: middle;" class="text-bold">
                                ...
                                <td style="width: 50px;">
                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txqty" runat="server" CssClass="form-control input-sm" TextMode="Number" ></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                ...
                                <td style="width: 100px;">
                                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="cbUOM2" runat="server" CssClass="auto-style3 form-control input-sm" AutoPostBack="True" OnSelectedIndexChanged="cbUOM_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
