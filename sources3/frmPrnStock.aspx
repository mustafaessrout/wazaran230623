<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmPrnStock.aspx.cs" Inherits="frmPrnStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="alert alert-bullet text-bold">Print Stock Report</div>
    <%--<div class="h-divider"></div> --%>
    <div class="container block-shadow-info">
        <div class="row margin-bottom margin-top">
            ...
            <div class="col-sm-6">
                <div class="clearfix form-group">
                    ...
                    <div class="col-sm-10 drop-down">
                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="cbSalesPointCD" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbSalesPointCD_SelectedIndexChanged1">
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                ...
                <div class="clearfix form-group">
                    <label class="control-label col-sm-2">UOM Based</label>
                    <div class="col-sm-10 drop-down">
                ...
                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                    <ContentTemplate>
                        <asp:RadioButtonList ID="rbRpt" runat="server" AutoPostBack="True" DataValueField="D" OnSelectedIndexChanged="rbRpt_SelectedIndexChanged" RepeatDirection="Horizontal" CssClass="radio radio-inline">
                            ...
                            <asp:ListItem Enabled="False" Value="S">Summary</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="S2">Summary 2</asp:ListItem>
                            <asp:ListItem Value="T">Detail Transaction</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="J">Jared</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="F">Form</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="I">Stock Invoice</asp:ListItem>
                            <asp:ListItem Enabled="False" Value="ILV">Stock Invoice LV</asp:ListItem>
                        </asp:RadioButtonList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        ...
        <div class="navi row padding-bottom padding-top margin-top text-center">
            ...
            <asp:Button ID="btexcel" runat="server" CssClass="btn-info btn btn-print" Text="Print Raw Data" OnClick="btexcel_Click" />
            <%--<asp:Button ID="btexcel" runat="server" CssClass="btn-info btn btn-print" Text="Export to Excel" OnClick="btexcel_Click" />--%>
        </div>
