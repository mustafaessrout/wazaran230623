<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_loginol.aspx.cs" Inherits="fm_loginol" %>
...
<body class="login4 center middle" style="height: 100%;">
    ...
    <div class="content">
        <div class="logo ">
            <img src="logo.png" alt="logo indomorocco"/>
        </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div style="margin-top: 15px">
                                <asp:LinkButton ID="lbforgot" Text="forgot Password ?" runat="server" OnClick="lbforgot_Click" CssClass="text-primary" Visible="false"></asp:LinkButton>
                                <asp:LinkButton ID="lbchange" Text="Change Password ?" runat="server" OnClick="lbchange_Click" CssClass="text-primary"></asp:LinkButton>
                            </div>
                        </ContentTemplate>
                        <Triggers>
