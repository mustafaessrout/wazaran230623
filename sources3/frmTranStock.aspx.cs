...
using System.IO;
public partial class frmTranStock : System.Web.UI.Page
{
    cbll bll = new cbll();
    ...
    private void bindinggrd()
    {
        try
        {
            ...
            bll.vBindingGridToSp(ref grd, "sp_tbltrnstockDtl_get", arr);
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "tabFix", "tabFix();", true);
    ...
    {
        Response.Redirect("frmTranStock.aspx");
    }
    protected void btsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if ((txtrnstkNo.Text == "NEW" || txtrnstkNo.Text == "") && lbstatus.Text == "NEW")
            {
                ...
                arr.Add(new cArrayList("@salespointcd", cbSalesPointCD.SelectedValue));
                rep.vShowReportToPDFWithSP("rptTranStock.rpt", arr, sPath + sPdfName);
    ...
    protected void btadd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txqty.Text == "")
            {
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "al", "sweetAlert('Attention','Please fill Quantity coloumn','warning');", true);
