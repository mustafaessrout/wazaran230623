    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:DropDownList ID="cbsp" CssClass="form-control-static" runat="server"></asp:DropDownList><asp:CheckBox ID="chall" CssClass="form-control-static" runat="server" Text="ALL" />
                </div>
