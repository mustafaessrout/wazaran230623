<%@ Page Title="" Language="C#" MasterPageFile="~/admin/promotor2.master" AutoEventWireup="true" CodeFile="fm_employeeUpdateInfo.aspx.cs" Inherits="fm_employeeUpdateInfo" %>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                        <ContentTemplate>
                            <img src="www.vom" id="imgEmployeePhoto" runat="server" alt="photo" style="width: 103px; height: 66px;" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 require">
                    <asp:UpdatePanel ID="UpdatePanel37" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtemployee_app_cd" runat="server" Text="" MaxLength="10" CssClass="form-control input-sm"></asp:TextBox>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 ">
                        <asp:UpdatePanel ID="UpdatePanel39" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtPlate1" runat="server" Text="" CssClass="" Width="80" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlate2" runat="server" Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlate3" runat="server" Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlate4" runat="server" Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <asp:UpdatePanel ID="UpdatePanel40" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtPlateArabic1" runat="server"   Text="" CssClass="" Width="80" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlateArabic2" runat="server"  Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlateArabic3" runat="server" Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                                <asp:TextBox ID="txtPlateArabic4" runat="server"  Text="" CssClass="" Width="30" placeholder=""></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
