<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_mstcontract3_uom.aspx.cs" Inherits="fm_mstcontract3_uom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="alert alert-info text-bold">Order Free / Bonus Entry</div>
    <div id="container">
                            ...
                            <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" GridLines="None" OnRowDeleting="grd_RowDeleting" OnRowDataBound="grd_RowDataBound" ShowFooter="True" OnSelectedIndexChanging="grd_SelectedIndexChanging" CssClass="mGrid" CellPadding="0">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SubTotal">
                                        <ItemTemplate>
                                            <asp:Label ID="lbsubtotal" runat="server" Text='<%# Eval("subtotal","{0:f5}") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
