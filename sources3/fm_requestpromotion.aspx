<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="fm_requestpromotion.aspx.cs" Inherits="fm_requestpromotion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function PropSelected(sender, e) {
            ...
            $get('<%=btproposal.ClientID%>').click();
        }
        function AppSelected(sender, e) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="btproposal" runat="server" Text="Button" Style="display: none" OnClick="btproposal_Click" />

    <div class="form-horizontal" style="font-family: Calibri">
        <h4 class="jajarangenjang">
            <asp:Label ID="lbtitle" runat="server" Text="Request Promotion (Entry)"></asp:Label>
        </h4>
        ...
        <fieldset class="hover-title">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <asp:RadioButtonList ID="rdpromotion" runat="server" CssClass="col-form-label-sm" CellPadding="0" CellSpacing="0" RepeatDirection="Horizontal" >
                                <asp:ListItem Value="BB" Selected="True" >Promotion By Branch</asp:ListItem>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <asp:TextBox ID="dtstart" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnTextChanged="dtstart_TextChanged"></asp:TextBox>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <ContentTemplate>
                            <asp:TextBox ID="dtend" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnTextChanged="dtend_TextChanged"
                                ></asp:TextBox>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <asp:TextBox ID="dtdelivery" runat="server" CssClass="form-control input-sm" AutoPostBack="true" OnTextChanged="dtdelivery_TextChanged"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <asp:DropDownList ID="cbpaymenttype" runat="server" CssClass="form-control input-sm" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="cbpaymenttype_SelectedIndexChanged">
                                <asp:ListItem Value="FG">By Free Good</asp:ListItem>
                                <asp:ListItem Value="CH">By Cash Amount</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="lbproposal" class="col-xs-3 col-form-label col-form-label-sm">Have Proposal No ?</label>
                        <asp:RadioButtonList ID="rdProposal" runat="server" CssClass="col-xs-1 col-form-label-sm" CellPadding="0" CellSpacing="0" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdProposal_SelectedIndexChanged" >
                            <asp:ListItem Value="Y">Yes</asp:ListItem>
                            <asp:ListItem Value="N" Selected="True">No</asp:ListItem>
                        </asp:RadioButtonList>
                        <%--<asp:CheckBox ID="chproposal" runat="server" CssClass="col-xs-1 col-form-label-sm" AutoPostBack="true" OnCheckedChanged="chproposal_CheckedChanged" />--%>
                        <div class="col-xs-8" runat="server" id="viewProposal">
                            <asp:TextBox ID="txproposal" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                <asp:AutoCompleteExtender CompletionListCssClass="auto-complate-list" CompletionListHighlightedItemCssClass="auto-complate-hover" CompletionListItemCssClass="auto-complate-item" ID="txproposal_AutoCompleteExtender" runat="server" ServiceMethod="GetListProposal" TargetControlID="txproposal" UseContextKey="True" MinimumPrefixLength="1" EnableCaching="false" FirstRowSelected="false" CompletionInterval="10" CompletionSetCount="1" ShowOnlyCurrentWordInCompletionListItem="true" OnClientItemSelected="PropSelected" >
                                </asp:AutoCompleteExtender>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" runat="server" id="branch">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <asp:DropDownList ID="cbsalespoint" runat="server" CssClass="form-control input-sm"  Width="100%">
                            </asp:DropDownList>
                        </div>
                        <div class="col-xs-2">
                            <asp:Button ID="btaddbranch" runat="server" Text="Add" CssClass="btn btn-default" OnClick="btaddbranch_Click"  />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ContentTemplate>
                        <div class="table-responsive">
                                <asp:GridView ID="grdsalespoint" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowDeleting="grdsalespoint_RowDeleting">
                                <Columns>
                                    <asp:TemplateField HeaderText="Salespoint Code">
                                        <ItemTemplate>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <asp:TextBox ID="txapproval" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                <asp:AutoCompleteExtender CompletionListCssClass="auto-complate-list" CompletionListHighlightedItemCssClass="auto-complate-hover" CompletionListItemCssClass="auto-complate-item" ID="AutoCompleteExtender1" runat="server" ServiceMethod="GetListApproval" TargetControlID="txapproval" UseContextKey="True" MinimumPrefixLength="1" EnableCaching="false" FirstRowSelected="false" CompletionInterval="10" CompletionSetCount="1" ShowOnlyCurrentWordInCompletionListItem="true" OnClientItemSelected="AppSelected" >
                                </asp:AutoCompleteExtender>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="approveby" class="col-xs-4 col-form-label col-form-label-sm">Noted (if Rejected)</label>
                        <div class="col-xs-8">
                            <asp:TextBox ID="txnoted" runat="server" CssClass="form-control input-sm" TextMode="MultiLine" ReadOnly="true" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="clearfix margin-bottom">
            <label class="col-md-2 col-sm-4 control-label">Upload Document Promotion</label>
            <div class="col-md-8 col-sm-8">
                ...
                <asp:HyperLink id="hpfile_nm" runat="server" Visible="False" ForeColor="blue" class="example-image-link" data-lightbox="example-1">
                    <asp:Label id="lblocfile" runat="server" Text='Promotion Document'></asp:Label>
                </asp:HyperLink>
            </div>
        </div>
