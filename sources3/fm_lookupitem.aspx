<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fm_lookupitem.aspx.cs" Inherits="fm_lookupitem" %>
...
<body style="font-family:Tahoma,Verdana;font-size:small">
    ...
    <div class="auto-style1">
      ...
      <div style="padding:10px 10px 10px 10px">
          Warehouse : <asp:DropDownList ID="cbwhs" runat="server" OnSelectedIndexChanged="cbwhs_SelectedIndexChanged" AutoPostBack="True" Width="10em"></asp:DropDownList> | Bin : <asp:DropDownList ID="cbbin" runat="server" OnSelectedIndexChanged="cbbin_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList> | UOM FREE :<asp:DropDownList ID="cbuomfree" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cbuomfree_SelectedIndexChanged" Width="10em">
          </asp:DropDownList>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Item Name">
                        <ItemTemplate>
                            <asp:Label ID="lbitemname" runat="server" Text='<%# Eval("item_shortname") %>'></asp:Label>
                         </ItemTemplate>   
                    </asp:TemplateField>
